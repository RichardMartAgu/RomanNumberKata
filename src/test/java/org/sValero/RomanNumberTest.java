...
public class RomanNumberTest {
    ...
    public void convertTest() {
        ...
        Assert.assertEquals("MCLXXII", RomanNumberConvert.convert(ONE_THOUSAND_ONE_HUNDRED_SEVENTY_TWO));
        ...
        Assert.assertEquals("MDCCCLXVIII", RomanNumberConvert.convert(ONE_THOUSAND_EIGHT_HUNDRED_SIXTY_EIGHT));
        Assert.assertEquals("MDCCCLXXV", RomanNumberConvert.convert(ONE_THOUSAND_EIGHT_HUNDRED_SEVENTY_FIVE));
        Assert.assertEquals("MCMXCIX", RomanNumberConvert.convert(ONE_THOUSAND_NINE_HUNDRED_NINETY_NINE));
        ...
        Assert.assertEquals("MMCCXXXVII", RomanNumberConvert.convert(TWO_THOUSAND_TWO_HUNDRED_THIRTY_SEVEN));
        Assert.assertEquals("MMCDLXVIII", RomanNumberConvert.convert(TWO_THOUSAND_FOUR_HUNDRED_SIXTY_EIGHT));
        ...
        Assert.assertEquals("MMDCCCXXXIII", RomanNumberConvert.convert(TWO_THOUSAND_EIGHT_HUNDRED_THIRTY_THREE));
        Assert.assertEquals("MMCMLXXV", RomanNumberConvert.convert(TWO_THOUSAND_NINE_HUNDRED_SEVENTY_FIVE));
        Assert.assertEquals("MMCMXCIX", RomanNumberConvert.convert(TWO_THOUSAND_NINE_HUNDRED_NINETY_NINE));
